...
public abstract class Input<T> {
	...
	throws InputErrorException {
		//tryParseEntity将通过input查询的对象强制转换成ObjectType.class对象所表示的类或接口
	...
	throws InputErrorException {
		try {
			//cast方法：表示将一个对象强制转换成此Class对象所表示的类或者接口，将ent所表示的对象强制转换成aClass对象所表示的类或接口
	...
	public static <T extends Entity> T tryParseEntity(JaamSimModel simModel, String choice, Class<T> aClass) {
		//将simModel.getNamedEntity(choice)查询出的对象强制转换成aClass对象所表示的类或接口
